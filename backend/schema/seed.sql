...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('b860463c-5e1d-4c00-94bd-7cb4ca420b67', NULL, 'subflow', 'Subflow', 'Execute another workflow', 'integration', 'workflow', '{"type": "object", "properties": {"workflow_id": {"type": "string", "format": "uuid"}, "workflow_version": {"type": "integer"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "SUBFLOW_001", "name": "NOT_FOUND", "retryable": false, "description": "Subflow workflow not found"}, {"code": "SUBFLOW_002", "name": "EXEC_ERROR", "retryable": true, "description": "Subflow execution error"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:30.000222+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Subflow result"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": false, "description": "Input data for subflow"}]', NULL, NULL, NULL, '[]', false, 'return await ctx.workflow.run(config.workflow_id, input);', '{"icon": "workflow", "color": "#10B981"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('065ed730-c42e-4fdb-9ddf-0a16347926c4', NULL, 'map', 'Map', 'Process array items in parallel', 'data', 'layers', '{"type": "object", "properties": {"parallel": {"type": "boolean"}, "input_path": {"type": "string"}, "max_workers": {"type": "integer"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "MAP_001", "name": "INVALID_PATH", "retryable": false, "description": "Invalid input path"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.998717+00', '[{"name": "item", "label": "Item", "is_default": true, "description": "Each mapped item"}, {"name": "complete", "label": "Complete", "is_default": false, "description": "All items processed"}]', '[{"name": "items", "label": "Items", "schema": {"type": "array", "items": {"type": "any"}}, "required": true, "description": "Array of items to process"}]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('d90aa273-3ee1-4802-8165-aafbe87dcb5a', NULL, 'split', 'Split', 'Split into batches', 'data', 'scissors', '{"type": "object", "properties": {"batch_size": {"type": "integer", "minimum": 1}, "input_path": {"type": "string"}}}', NULL, NULL, 'builtin', NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.999493+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Split batches"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Data to split into branches"}]', NULL, NULL, NULL, '[]', false, '
const items = getPath(input, config.input_path) || [];
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('95ec4521-9a26-4031-80fd-4011d54a0470', NULL, 'function', 'Function', 'Execute custom JavaScript', 'utility', 'code', '{"type": "object", "properties": {"code": {"type": "string"}, "language": {"enum": ["javascript"], "type": "string"}, "timeout_ms": {"type": "integer"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "FUNC_001", "name": "SYNTAX_ERROR", "retryable": false, "description": "JavaScript syntax error"}, {"code": "FUNC_002", "name": "RUNTIME_ERROR", "retryable": false, "description": "JavaScript runtime error"}, {"code": "FUNC_003", "name": "TIMEOUT", "retryable": false, "description": "Function execution timeout"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:30.001214+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Function result"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": false, "description": "Input data for function"}]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('7483993e-c52a-49de-8051-68df5afe6ffb', NULL, 'wait', 'Wait', 'Pause execution', 'control', 'clock', '{"type": "object", "properties": {"until": {"type": "string", "format": "date-time"}, "duration_ms": {"type": "integer", "minimum": 0}}}', NULL, NULL, 'builtin', NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:30.000437+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Continues after wait"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": false, "description": "Data to pass through after wait"}]', NULL, NULL, NULL, '[]', false, '
if (config.duration_ms) {
    await new Promise(resolve => setTimeout(resolve, config.duration_ms));
}
return input;
', '{"icon": "clock", "color": "#6B7280"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('decf6fc1-edff-43dc-90bf-23b76d5ffdcf', NULL, 'condition', 'Condition', 'Branch based on expression', 'logic', 'git-branch', '{"type": "object", "properties": {"expression": {"type": "string", "description": "JSONPath expression"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "COND_001", "name": "INVALID_EXPR", "retryable": false, "description": "Invalid condition expression"}, {"code": "COND_002", "name": "EVAL_ERROR", "retryable": false, "description": "Expression evaluation error"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.997933+00', '[{"name": "true", "label": "Yes", "is_default": true, "description": "When condition is true"}, {"name": "false", "label": "No", "is_default": false, "description": "When condition is false"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Data to evaluate condition against"}]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('ce7d25be-8968-4fd8-91ef-a0a87cec7081', NULL, 'human_in_loop', 'Human in Loop', 'Wait for human approval', 'control', 'user-check', '{"type": "object", "properties": {"approval_url": {"type": "boolean"}, "instructions": {"type": "string"}, "timeout_hours": {"type": "integer"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "HIL_001", "name": "TIMEOUT", "retryable": false, "description": "Human approval timeout"}, {"code": "HIL_002", "name": "REJECTED", "retryable": false, "description": "Human rejected"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:30.000697+00', '[{"name": "approved", "label": "Approved", "is_default": true, "description": "When approved"}, {"name": "rejected", "label": "Rejected", "is_default": false, "description": "When rejected"}, {"name": "timeout", "label": "Timeout", "is_default": false, "description": "When timed out"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Context data for human review"}]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('2319b4e4-2060-4341-b8ab-18c6196b005b', NULL, 'loop', 'Loop', 'Iterate with for/forEach/while', 'logic', 'repeat', '{"type": "object", "properties": {"count": {"type": "integer"}, "condition": {"type": "string"}, "loop_type": {"enum": ["for", "forEach", "while", "doWhile"], "type": "string"}, "input_path": {"type": "string"}, "max_iterations": {"type": "integer"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "LOOP_001", "name": "MAX_ITERATIONS", "retryable": false, "description": "Maximum iterations exceeded"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.998477+00', '[{"name": "loop", "label": "Loop Body", "is_default": true, "description": "Each iteration"}, {"name": "complete", "label": "Complete", "is_default": false, "description": "When loop finishes"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Initial value or array to iterate"}]', NULL, NULL, NULL, '[]', false, '
const results = [];
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('210a9570-8b4a-49e8-b243-5f7a76c2e5e6', NULL, 'start', 'Start', 'Workflow entry point', 'control', 'play', '{}', NULL, NULL, 'builtin', NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.996184+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Workflow input data"}]', '[]', NULL, NULL, NULL, '[]', false, 'return input;', '{"icon": "play", "color": "#10B981"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('942ce139-4c4f-4a9b-91ec-4fa1efdabe1f', NULL, 'note', 'Note', 'Documentation/comment', 'utility', 'file-text', '{"type": "object", "properties": {"color": {"type": "string"}, "content": {"type": "string"}}}', NULL, NULL, 'builtin', NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:30.001694+00', '[]', '[]', NULL, NULL, NULL, '[]', false, 'return input;', '{"icon": "file-text", "color": "#9CA3AF"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('b1817047-47fe-4c07-af12-9ecff95b84fd', NULL, 'join', 'Join', 'Merge multiple branches', 'data', 'git-merge', '{}', NULL, NULL, 'builtin', NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.998975+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Merged data"}]', '[{"name": "input_1", "label": "Input 1", "schema": {"type": "any"}, "required": false, "description": "First branch result"}, {"name": "input_2", "label": "Input 2", "schema": {"type": "any"}, "required": false, "description": "Second branch result"}, {"name": "input_3", "label": "Input 3", "schema": {"type": "any"}, "required": false, "description": "Third branch result"}, {"name": "input_4", "label": "Input 4", "schema": {"type": "any"}, "required": false, "description": "Fourth branch result"}]', NULL, NULL, NULL, '[]', false, 'return input;', '{"icon": "git-merge", "color": "#06B6D4"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('467509dd-df43-422a-be21-4b70694bb75a', NULL, 'filter', 'Filter', 'Filter items by condition', 'data', 'filter', '{"type": "object", "properties": {"keep_all": {"type": "boolean"}, "expression": {"type": "string"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "FILTER_001", "name": "INVALID_EXPR", "retryable": false, "description": "Invalid filter expression"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.999238+00', '[{"name": "matched", "label": "Matched", "is_default": true, "description": "Items matching condition"}, {"name": "unmatched", "label": "Unmatched", "is_default": false, "description": "Items not matching"}]', '[{"name": "items", "label": "Items", "schema": {"type": "array", "items": {"type": "any"}}, "required": true, "description": "Array of items to filter"}]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('722549c9-c09e-44ad-873b-bd2b685ef8d9', NULL, 'tool', 'Tool', 'Execute external tool/adapter', 'integration', 'wrench', '{"type": "object", "properties": {"adapter_id": {"type": "string"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "TOOL_001", "name": "ADAPTER_NOT_FOUND", "retryable": false, "description": "Adapter not found"}, {"code": "TOOL_002", "name": "EXEC_ERROR", "retryable": true, "description": "Tool execution error"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:30.000005+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Tool execution result"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": false, "description": "Input data for the tool"}]', NULL, NULL, NULL, '[]', false, 'return await ctx.adapter.call(config.adapter_id, input);', '{"icon": "wrench", "color": "#10B981"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('6cd425ce-6314-433a-a827-3ad66a2e5e48', NULL, 'log', 'Log', 'Output log messages for debugging', 'utility', 'terminal', '{"type": "object", "properties": {"data": {"type": "string", "description": "JSON path to include additional data (e.g. $.input)"}, "level": {"enum": ["debug", "info", "warn", "error"], "type": "string", "default": "info", "description": "Log level"}, "message": {"type": "string", "description": "Log message (supports {{$.field}} template variables)"}}}', NULL, NULL, 'builtin', NULL, '[]', true, '2026-01-12 09:23:29.764471+00', '2026-01-12 09:23:29.764471+00', '[]', '[]', NULL, NULL, NULL, '[]', false, NULL, '{}', false, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('eab46517-3672-40f6-82fe-88a6313cdce0', NULL, 'switch', 'Switch', 'Multi-branch routing', 'logic', 'shuffle', '{"type": "object", "properties": {"mode": {"enum": ["rules", "expression"], "type": "string"}, "cases": {"type": "array", "items": {"type": "object", "properties": {"name": {"type": "string"}, "expression": {"type": "string"}, "is_default": {"type": "boolean"}}}}}}', NULL, NULL, 'builtin', NULL, '[{"code": "SWITCH_001", "name": "NO_MATCH", "retryable": false, "description": "No matching case"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.998206+00', '[{"name": "default", "label": "Default", "is_default": true, "description": "When no case matches"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Value to switch on"}]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('034d56d2-56c4-48c8-8319-f7b4fdaf79fc', NULL, 'aggregate', 'Aggregate', 'Aggregate data operations', 'data', 'database', '{"type": "object", "properties": {"group_by": {"type": "string"}, "operations": {"type": "array", "items": {"type": "object", "properties": {"field": {"type": "string"}, "operation": {"enum": ["sum", "count", "avg", "min", "max", "first", "last", "concat"], "type": "string"}, "output_field": {"type": "string"}}}}}}', NULL, NULL, 'builtin', NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.999739+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Aggregated result"}]', '[{"name": "input_1", "label": "Input 1", "schema": {"type": "any"}, "required": false, "description": "First data source"}, {"name": "input_2", "label": "Input 2", "schema": {"type": "any"}, "required": false, "description": "Second data source"}, {"name": "input_3", "label": "Input 3", "schema": {"type": "any"}, "required": false, "description": "Third data source"}, {"name": "input_4", "label": "Input 4", "schema": {"type": "any"}, "required": false, "description": "Fourth data source"}]', NULL, NULL, NULL, '[]', false, '
const items = Array.isArray(input) ? input : (input.items || []);
const result = {};
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('97f46b68-380a-4094-8e38-c3071724795d', NULL, 'error', 'Error', 'Stop workflow with error', 'control', 'alert-circle', '{"type": "object", "properties": {"error_code": {"type": "string"}, "error_type": {"type": "string"}, "error_message": {"type": "string"}}}', NULL, NULL, 'builtin', NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:30.000962+00', '[]', '[{"name": "error", "label": "Error", "schema": {"type": "object", "properties": {"code": {"type": "string"}, "message": {"type": "string"}}}, "required": true, "description": "Error information to handle"}]', NULL, NULL, NULL, '[]', false, '
throw new Error(config.error_message || ''Workflow stopped with error'');
', '{"icon": "alert-circle", "color": "#EF4444"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('31a7de23-04aa-4102-affa-aa782a6ddfbf', NULL, 'router', 'Router', 'AI-driven dynamic routing', 'ai', 'git-branch', '{"type": "object", "properties": {"model": {"type": "string"}, "routes": {"type": "array", "items": {"type": "object", "properties": {"name": {"type": "string"}, "description": {"type": "string"}}}}, "provider": {"type": "string"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "ROUTER_001", "name": "NO_MATCH", "retryable": false, "description": "No matching route found"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:30.001445+00', '[{"name": "default", "label": "Default", "is_default": true, "description": "Default route when no match"}]', '[{"name": "input", "label": "Input", "schema": {"type": "string"}, "required": true, "description": "Message to analyze for routing"}]', NULL, NULL, NULL, '[{"name": "llm_api_key", "type": "api_key", "scope": "system", "required": true, "description": "LLM Provider API Key"}]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('463514db-ad3a-47b8-9f93-a01d2bcda8bc', NULL, 'http', 'HTTP Request', 'Make HTTP API calls', 'integration', 'globe', '{"type": "object", "properties": {"url": {"type": "string"}, "body": {"type": "object"}, "method": {"enum": ["GET", "POST", "PUT", "DELETE", "PATCH"], "type": "string"}, "headers": {"type": "object"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "HTTP_001", "name": "CONNECTION_ERROR", "retryable": true, "description": "Failed to connect"}, {"code": "HTTP_002", "name": "TIMEOUT", "retryable": true, "description": "Request timeout"}]', true, '2026-01-12 09:23:30.001921+00', '2026-01-12 09:23:30.001921+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('37e0928b-6717-4cbf-96f3-ca3928b4d394', NULL, 'code', 'Code', 'Execute custom JavaScript code', 'utility', 'terminal', '{"type": "object", "properties": {"code": {"type": "string", "description": "JavaScript code to execute"}}}', NULL, NULL, 'builtin', NULL, '[{"code": "CODE_001", "name": "SYNTAX_ERROR", "retryable": false, "description": "JavaScript syntax error"}, {"code": "CODE_002", "name": "RUNTIME_ERROR", "retryable": false, "description": "JavaScript runtime error"}]', true, '2026-01-12 09:23:30.00232+00', '2026-01-12 09:23:30.00232+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '// User code is dynamically injected\nreturn input;', '{"icon": "terminal", "color": "#6366F1"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('207aaa19-cd68-4bd4-b42c-d670fae4e77c', NULL, 'slack', 'Slack', 'Slackチャンネルにメッセージを送信', 'integration', 'message-square', '{"type": "object", "required": ["message"], "properties": {"blocks": {"type": "array", "title": "Block Kit", "description": "Slack Block Kit形式のメッセージ（JSON）", "x-ui-widget": "json"}, "channel": {"type": "string", "title": "チャンネル", "description": "投稿先チャンネル（#general など）"}, "message": {"type": "string", "title": "メッセージ", "description": "送信するメッセージ（テンプレート使用可: ${input.field}）", "x-ui-widget": "textarea"}, "username": {"type": "string", "title": "表示名", "description": "ボットの表示名"}, "icon_emoji": {"type": "string", "title": "アイコン絵文字", "description": "ボットのアイコン（:robot_face: など）"}, "webhook_url": {"type": "string", "title": "Webhook URL", "description": "Slack Incoming Webhook URL（空の場合はシークレットSLACK_WEBHOOK_URLを使用）"}}}', '{"type": "object"}', '{"type": "object", "properties": {"status": {"type": "number"}, "success": {"type": "boolean"}}}', 'builtin', NULL, '[{"code": "SLACK_001", "name": "WEBHOOK_NOT_CONFIGURED", "retryable": false, "description": "Webhook URLが設定されていません"}, {"code": "SLACK_002", "name": "SEND_FAILED", "retryable": true, "description": "メッセージ送信に失敗しました"}, {"code": "SLACK_003", "name": "INVALID_WEBHOOK", "retryable": false, "description": "無効なWebhook URL"}]', true, '2026-01-12 09:23:30.218182+00', '2026-01-12 09:23:30.218182+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('4192fef4-6164-412a-920f-f9d9143fb790', NULL, 'discord', 'Discord', 'Discord Webhookにメッセージを送信', 'integration', 'message-circle', '{"type": "object", "required": ["content"], "properties": {"embeds": {"type": "array", "title": "Embeds", "description": "リッチな埋め込みメッセージ（JSON配列）", "x-ui-widget": "json"}, "content": {"type": "string", "title": "メッセージ", "description": "送信するメッセージ（テンプレート使用可）", "x-ui-widget": "textarea"}, "username": {"type": "string", "title": "ユーザー名", "description": "Webhookの表示名を上書き"}, "avatar_url": {"type": "string", "title": "アバターURL", "description": "Webhookのアバター画像URL"}, "webhook_url": {"type": "string", "title": "Webhook URL", "description": "Discord Webhook URL（空の場合はシークレットDISCORD_WEBHOOK_URLを使用）"}}}', '{"type": "object"}', '{"type": "object", "properties": {"status": {"type": "number"}, "success": {"type": "boolean"}}}', 'builtin', NULL, '[{"code": "DISCORD_001", "name": "WEBHOOK_NOT_CONFIGURED", "retryable": false, "description": "Webhook URLが設定されていません"}, {"code": "DISCORD_002", "name": "SEND_FAILED", "retryable": true, "description": "メッセージ送信に失敗しました"}, {"code": "DISCORD_003", "name": "RATE_LIMITED", "retryable": true, "description": "レート制限に達しました"}]', true, '2026-01-12 09:23:30.219664+00', '2026-01-12 09:23:30.219664+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('608c9830-b4b8-42f3-9716-9289b263188c', NULL, 'notion_create_page', 'Notion: ページ作成', 'Notionにページを作成', 'integration', 'file-text', '{"type": "object", "required": ["parent_id"], "properties": {"title": {"type": "string", "title": "タイトル", "description": "ページタイトル（テンプレート使用可）"}, "api_key": {"type": "string", "title": "API Key", "description": "Notion API Key（空の場合はシークレットNOTION_API_KEYを使用）"}, "content": {"type": "string", "title": "本文", "description": "ページの本文コンテンツ（テンプレート使用可）", "x-ui-widget": "textarea"}, "parent_id": {"type": "string", "title": "親ID", "description": "親ページまたはデータベースのID"}, "properties": {"type": "object", "title": "プロパティ", "description": "DBプロパティ（JSON形式）", "x-ui-widget": "json"}, "parent_type": {"enum": ["page_id", "database_id"], "type": "string", "title": "親タイプ", "default": "database_id"}}}', '{"type": "object"}', '{"type": "object", "properties": {"id": {"type": "string"}, "url": {"type": "string"}, "created_time": {"type": "string"}}}', 'builtin', NULL, '[{"code": "NOTION_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "NOTION_002", "name": "CREATE_FAILED", "retryable": true, "description": "ページ作成に失敗しました"}, {"code": "NOTION_003", "name": "INVALID_PARENT", "retryable": false, "description": "無効な親IDです"}]', true, '2026-01-12 09:23:30.220201+00', '2026-01-12 09:23:30.220201+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('1b182587-c5c1-4bda-aa14-0c456459be1a', NULL, 'notion_query_db', 'Notion: DB検索', 'Notionデータベースを検索', 'integration', 'database', '{"type": "object", "required": ["database_id"], "properties": {"sorts": {"type": "array", "title": "ソート", "description": "ソート条件（JSON配列）", "x-ui-widget": "json"}, "filter": {"type": "object", "title": "フィルター", "description": "Notion Filter形式（JSON）", "x-ui-widget": "json"}, "api_key": {"type": "string", "title": "API Key", "description": "Notion API Key（空の場合はシークレットNOTION_API_KEYを使用）"}, "page_size": {"type": "number", "title": "取得件数", "default": 100, "maximum": 100, "minimum": 1}, "database_id": {"type": "string", "title": "データベースID", "description": "検索対象のデータベースID"}}}', '{"type": "object"}', '{"type": "object", "properties": {"results": {"type": "array"}, "has_more": {"type": "boolean"}, "next_cursor": {"type": "string"}}}', 'builtin', NULL, '[{"code": "NOTION_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "NOTION_004", "name": "QUERY_FAILED", "retryable": true, "description": "クエリに失敗しました"}]', true, '2026-01-12 09:23:30.220729+00', '2026-01-12 09:23:30.220729+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
const apiKey = config.api_key || ctx.secrets.NOTION_API_KEY;
if (!apiKey) {
    throw new Error(''[NOTION_001] API Keyが設定されていません'');
}
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('5eddf8f1-4913-4c29-8934-68c59a72e603', NULL, 'gsheets_append', 'Google Sheets: 行追加', 'Google Sheetsに行を追加', 'integration', 'table', '{"type": "object", "required": ["spreadsheet_id", "values"], "properties": {"range": {"type": "string", "title": "範囲", "default": "Sheet1!A:Z", "description": "シート名と範囲（例: Sheet1!A:Z）"}, "values": {"type": "array", "title": "値", "description": "追加する行データ（2次元配列またはテンプレート）", "x-ui-widget": "json"}, "api_key": {"type": "string", "title": "API Key", "description": "Google API Key（空の場合はシークレットGOOGLE_API_KEYを使用）"}, "spreadsheet_id": {"type": "string", "title": "スプレッドシートID", "description": "URLから取得: /d/{spreadsheet_id}/edit"}, "value_input_option": {"enum": ["RAW", "USER_ENTERED"], "type": "string", "title": "入力形式", "default": "USER_ENTERED"}}}', '{"type": "object"}', '{"type": "object", "properties": {"updated_rows": {"type": "number"}, "updated_cells": {"type": "number"}, "updated_range": {"type": "string"}}}', 'builtin', NULL, '[{"code": "GSHEETS_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "GSHEETS_002", "name": "APPEND_FAILED", "retryable": true, "description": "行追加に失敗しました"}, {"code": "GSHEETS_003", "name": "INVALID_SPREADSHEET", "retryable": false, "description": "スプレッドシートが見つかりません"}]', true, '2026-01-12 09:23:30.221106+00', '2026-01-12 09:23:30.221106+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('825d2ae5-9808-496d-b4e0-dcf2f8e6afe5', NULL, 'github_add_comment', 'GitHub: コメント追加', 'GitHub IssueまたはPRにコメントを追加', 'integration', 'message-square', '{"type": "object", "required": ["owner", "repo", "issue_number", "body"], "properties": {"body": {"type": "string", "title": "コメント本文", "description": "コメント本文（Markdown、テンプレート使用可）", "x-ui-widget": "textarea"}, "repo": {"type": "string", "title": "リポジトリ"}, "owner": {"type": "string", "title": "オーナー"}, "token": {"type": "string", "title": "アクセストークン", "description": "GitHub Personal Access Token（空の場合はシークレットGITHUB_TOKENを使用）"}, "issue_number": {"type": "number", "title": "Issue/PR番号"}}}', '{"type": "object"}', '{"type": "object", "properties": {"id": {"type": "number"}, "url": {"type": "string"}, "html_url": {"type": "string"}}}', 'builtin', NULL, '[{"code": "GITHUB_001", "name": "TOKEN_NOT_CONFIGURED", "retryable": false, "description": "トークンが設定されていません"}, {"code": "GITHUB_004", "name": "COMMENT_FAILED", "retryable": true, "description": "コメント追加に失敗しました"}]', true, '2026-01-12 09:23:30.222311+00', '2026-01-12 09:23:30.222311+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
const token = config.token || ctx.secrets.GITHUB_TOKEN;
if (!token) {
    throw new Error(''[GITHUB_001] トークンが設定されていません'');
}
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('e1d99e22-5348-4e8b-9c44-a1a7e82cbb83', NULL, 'web_search', 'Web検索', 'Tavily APIでWeb検索を実行', 'integration', 'search', '{"type": "object", "required": ["query"], "properties": {"query": {"type": "string", "title": "検索クエリ", "description": "検索キーワード（テンプレート使用可）"}, "api_key": {"type": "string", "title": "API Key", "description": "Tavily API Key（空の場合はシークレットTAVILY_API_KEYを使用）"}, "max_results": {"type": "number", "title": "最大結果数", "default": 5, "maximum": 20, "minimum": 1}, "search_depth": {"enum": ["basic", "advanced"], "type": "string", "title": "検索深度", "default": "basic"}, "include_answer": {"type": "boolean", "title": "AI回答を含める", "default": true}, "exclude_domains": {"type": "array", "items": {"type": "string"}, "title": "除外ドメイン"}, "include_domains": {"type": "array", "items": {"type": "string"}, "title": "含めるドメイン"}}}', '{"type": "object"}', '{"type": "object", "properties": {"answer": {"type": "string"}, "results": {"type": "array", "items": {"type": "object", "properties": {"url": {"type": "string"}, "score": {"type": "number"}, "title": {"type": "string"}, "content": {"type": "string"}}}}}}', 'builtin', NULL, '[{"code": "SEARCH_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "SEARCH_002", "name": "SEARCH_FAILED", "retryable": true, "description": "検索に失敗しました"}]', true, '2026-01-12 09:23:30.222703+00', '2026-01-12 09:23:30.222703+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('fa2509a4-f899-4761-a20d-f67122fd2e1d', NULL, 'email_sendgrid', 'Email (SendGrid)', 'SendGrid APIでメールを送信', 'integration', 'mail', '{"type": "object", "required": ["from_email", "to_email", "subject", "content"], "properties": {"api_key": {"type": "string", "title": "API Key", "description": "SendGrid API Key（空の場合はシークレットSENDGRID_API_KEYを使用）"}, "content": {"type": "string", "title": "本文", "description": "メール本文（テンプレート使用可）", "x-ui-widget": "textarea"}, "subject": {"type": "string", "title": "件名", "description": "メール件名（テンプレート使用可）"}, "to_name": {"type": "string", "title": "受信者名"}, "to_email": {"type": "string", "title": "宛先メール", "description": "受信者のメールアドレス（テンプレート使用可）"}, "from_name": {"type": "string", "title": "送信者名"}, "from_email": {"type": "string", "title": "送信元メール", "description": "送信者のメールアドレス"}, "content_type": {"enum": ["text/plain", "text/html"], "type": "string", "title": "本文形式", "default": "text/plain"}}}', '{"type": "object"}', '{"type": "object", "properties": {"success": {"type": "boolean"}, "message_id": {"type": "string"}}}', 'builtin', NULL, '[{"code": "EMAIL_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "EMAIL_002", "name": "SEND_FAILED", "retryable": true, "description": "メール送信に失敗しました"}, {"code": "EMAIL_003", "name": "INVALID_EMAIL", "retryable": false, "description": "メールアドレスが無効です"}]', true, '2026-01-12 09:23:30.223087+00', '2026-01-12 09:23:30.223087+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, executor_type, executor_config, error_codes, enabled, created_at, updated_at, output_ports, input_ports, template_id, template_config, custom_code, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('02fc89f3-62d0-404b-bd10-9dcf9e3ac1c0', NULL, 'linear_create_issue', 'Linear: Issue作成', 'LinearにIssueを作成', 'integration', 'check-square', '{"type": "object", "required": ["team_id", "title"], "properties": {"title": {"type": "string", "title": "タイトル", "description": "Issueタイトル（テンプレート使用可）"}, "api_key": {"type": "string", "title": "API Key", "description": "Linear API Key（空の場合はシークレットLINEAR_API_KEYを使用）"}, "team_id": {"type": "string", "title": "チームID", "description": "LinearチームのID"}, "priority": {"enum": [0, 1, 2, 3, 4], "type": "number", "title": "優先度", "default": 0, "description": "0=なし, 1=緊急, 2=高, 3=中, 4=低"}, "label_ids": {"type": "array", "items": {"type": "string"}, "title": "ラベルID"}, "assignee_id": {"type": "string", "title": "担当者ID"}, "description": {"type": "string", "title": "説明", "description": "Issue説明（Markdown、テンプレート使用可）", "x-ui-widget": "textarea"}}}', '{"type": "object"}', '{"type": "object", "properties": {"id": {"type": "string"}, "url": {"type": "string"}, "identifier": {"type": "string"}}}', 'builtin', NULL, '[{"code": "LINEAR_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "LINEAR_002", "name": "CREATE_FAILED", "retryable": true, "description": "Issue作成に失敗しました"}]', true, '2026-01-12 09:23:30.223449+00', '2026-01-12 09:23:30.223449+00', '[]', '[]', NULL, NULL, NULL, '[]', false, '
