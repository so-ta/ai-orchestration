...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('b860463c-5e1d-4c00-94bd-7cb4ca420b67', NULL, 'subflow', 'Subflow', 'Execute another workflow', 'integration', 'workflow', '{"type": "object", "properties": {"workflow_id": {"type": "string", "format": "uuid"}, "workflow_version": {"type": "integer"}}}', '{"type": "object", "properties": {"input": {"type": "object", "description": "サブフローに渡す入力データ"}}, "description": "サブフローに渡すデータ"}', NULL, '[{"code": "SUBFLOW_001", "name": "NOT_FOUND", "retryable": false, "description": "Subflow workflow not found"}, {"code": "SUBFLOW_002", "name": "EXEC_ERROR", "retryable": true, "description": "Subflow execution error"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.990444+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Subflow result"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": false, "description": "Input data for subflow"}]', '[]', false, 'return await ctx.workflow.run(config.workflow_id, input);', '{"icon": "workflow", "color": "#10B981"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('7483993e-c52a-49de-8051-68df5afe6ffb', NULL, 'wait', 'Wait', 'Pause execution', 'control', 'clock', '{"type": "object", "properties": {"until": {"type": "string", "format": "date-time"}, "duration_ms": {"type": "integer", "minimum": 0}}}', '{"type": "object", "properties": {"data": {"type": "object", "description": "待機後にパススルーするデータ"}}, "description": "待機後にそのまま出力されるデータ"}', NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.988679+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Continues after wait"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": false, "description": "Data to pass through after wait"}]', '[]', false, '
if (config.duration_ms) {
    await new Promise(resolve => setTimeout(resolve, config.duration_ms));
}
return input;
', '{"icon": "clock", "color": "#6B7280"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('ce7d25be-8968-4fd8-91ef-a0a87cec7081', NULL, 'human_in_loop', 'Human in Loop', 'Wait for human approval', 'control', 'user-check', '{"type": "object", "properties": {"approval_url": {"type": "boolean"}, "instructions": {"type": "string"}, "timeout_hours": {"type": "integer"}}}', '{"type": "object", "properties": {"context": {"type": "object", "description": "承認者に表示するコンテキスト"}, "summary": {"type": "string", "description": "承認リクエストの概要"}}, "description": "承認者に表示されるコンテキストデータ"}', NULL, '[{"code": "HIL_001", "name": "TIMEOUT", "retryable": false, "description": "Human approval timeout"}, {"code": "HIL_002", "name": "REJECTED", "retryable": false, "description": "Human rejected"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.988502+00', '[{"name": "approved", "label": "Approved", "is_default": true, "description": "When approved"}, {"name": "rejected", "label": "Rejected", "is_default": false, "description": "When rejected"}, {"name": "timeout", "label": "Timeout", "is_default": false, "description": "When timed out"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Context data for human review"}]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('95ec4521-9a26-4031-80fd-4011d54a0470', NULL, 'function', 'Function', 'Execute custom JavaScript', 'utility', 'code', '{"type": "object", "properties": {"code": {"type": "string", "title": "コード", "x-ui-widget": "code"}, "language": {"enum": ["javascript"], "type": "string"}, "timeout_ms": {"type": "integer"}, "output_schema": {"type": "object", "title": "出力スキーマ", "description": "出力データのスキーマを定義（定義されたフィールドのみが次のステップに渡されます）", "x-ui-widget": "output-schema"}}}', '{"type": "object", "properties": {"data": {"type": "object", "description": "コード内で参照可能なデータ"}}, "description": "コード内で自由に参照可能なデータ"}', NULL, '[{"code": "FUNC_001", "name": "SYNTAX_ERROR", "retryable": false, "description": "JavaScript syntax error"}, {"code": "FUNC_002", "name": "RUNTIME_ERROR", "retryable": false, "description": "JavaScript runtime error"}, {"code": "FUNC_003", "name": "TIMEOUT", "retryable": false, "description": "Function execution timeout"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.989483+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Function result"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": false, "description": "Input data for function"}]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('210a9570-8b4a-49e8-b243-5f7a76c2e5e6', NULL, 'start', 'Start', 'Workflow entry point', 'control', 'play', '{"type": "object", "properties": {"input_schema": {"type": "object", "title": "入力スキーマ", "description": "ワークフロー実行時の入力データのスキーマを定義", "properties": {"type": {"type": "string", "default": "object"}, "required": {"type": "array", "items": {"type": "string"}}, "properties": {"type": "object"}}}}}', NULL, NULL, '[]', true, '2026-01-12 09:23:29.067836+00', '2026-01-12 09:23:29.996184+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Workflow input data"}]', '[]', '[]', false, 'return input;', '{"icon": "play", "color": "#10B981"}', true, 1);
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('722549c9-c09e-44ad-873b-bd2b685ef8d9', NULL, 'tool', 'Tool', 'Execute external tool/adapter', 'integration', 'wrench', '{"type": "object", "properties": {"adapter_id": {"type": "string"}}}', '{"type": "object", "properties": {"params": {"type": "object", "description": "ツールに渡すパラメータ"}}, "description": "ツールに渡すデータ"}', NULL, '[{"code": "TOOL_001", "name": "ADAPTER_NOT_FOUND", "retryable": false, "description": "Adapter not found"}, {"code": "TOOL_002", "name": "EXEC_ERROR", "retryable": true, "description": "Tool execution error"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.990203+00', '[{"name": "output", "label": "Output", "is_default": true, "description": "Tool execution result"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": false, "description": "Input data for the tool"}]', '[]', false, 'return await ctx.adapter.call(config.adapter_id, input);', '{"icon": "wrench", "color": "#10B981"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('467509dd-df43-422a-be21-4b70694bb75a', NULL, 'filter', 'Filter', 'Filter items by condition', 'data', 'filter', '{"type": "object", "properties": {"keep_all": {"type": "boolean"}, "expression": {"type": "string"}}}', '{"type": "object", "required": ["items"], "properties": {"items": {"type": "array", "description": "フィルター対象の配列"}}, "description": "Filter処理の入力データ"}', NULL, '[{"code": "FILTER_001", "name": "INVALID_EXPR", "retryable": false, "description": "Invalid filter expression"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.987415+00', '[{"name": "matched", "label": "Matched", "is_default": true, "description": "Items matching condition"}, {"name": "unmatched", "label": "Unmatched", "is_default": false, "description": "Items not matching"}]', '[{"name": "items", "label": "Items", "schema": {"type": "array", "items": {"type": "any"}}, "required": true, "description": "Array of items to filter"}]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('31a7de23-04aa-4102-affa-aa782a6ddfbf', NULL, 'router', 'Router', 'AI-driven dynamic routing', 'ai', 'git-branch', '{"type": "object", "properties": {"model": {"type": "string"}, "routes": {"type": "array", "items": {"type": "object", "properties": {"name": {"type": "string"}, "description": {"type": "string"}}}}, "provider": {"type": "string"}}}', '{"type": "object", "properties": {"message": {"type": "string", "description": "ルーティング判定対象のメッセージ"}}, "description": "ルーティング判定に使用するデータ"}', NULL, '[{"code": "ROUTER_001", "name": "NO_MATCH", "retryable": false, "description": "No matching route found"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.988314+00', '[{"name": "default", "label": "Default", "is_default": true, "description": "Default route when no match"}]', '[{"name": "input", "label": "Input", "schema": {"type": "string"}, "required": true, "description": "Message to analyze for routing"}]', '[{"name": "llm_api_key", "type": "api_key", "scope": "system", "required": true, "description": "LLM Provider API Key"}]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('37e0928b-6717-4cbf-96f3-ca3928b4d394', NULL, 'code', 'Code', 'Execute custom JavaScript code', 'utility', 'terminal', '{"type": "object", "properties": {"code": {"type": "string", "title": "コード", "description": "JavaScript code to execute", "x-ui-widget": "code"}, "output_schema": {"type": "object", "title": "出力スキーマ", "description": "出力データのスキーマを定義（定義されたフィールドのみが次のステップに渡されます）", "x-ui-widget": "output-schema"}}}', '{"type": "object", "properties": {"data": {"type": "object", "description": "コード内で参照可能なデータ"}}, "description": "コード内で自由に参照可能なデータ"}', NULL, '[{"code": "CODE_001", "name": "SYNTAX_ERROR", "retryable": false, "description": "JavaScript syntax error"}, {"code": "CODE_002", "name": "RUNTIME_ERROR", "retryable": false, "description": "JavaScript runtime error"}]', true, '2026-01-12 09:23:30.00232+00', '2026-01-13 09:35:31.989483+00', '[]', '[]', '[]', false, '// User code is dynamically injected\nreturn input;', '{"icon": "terminal", "color": "#6366F1"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('eab46517-3672-40f6-82fe-88a6313cdce0', NULL, 'switch', 'Switch', 'Multi-branch routing', 'logic', 'shuffle', '{"type": "object", "properties": {"mode": {"enum": ["rules", "expression"], "type": "string"}, "cases": {"type": "array", "items": {"type": "object", "properties": {"name": {"type": "string"}, "expression": {"type": "string"}, "is_default": {"type": "boolean"}}}}}}', '{"type": "object", "properties": {"value": {"type": "any", "description": "分岐条件で評価する値"}}, "description": "分岐条件で評価されるデータ"}', NULL, '[{"code": "SWITCH_001", "name": "NO_MATCH", "retryable": false, "description": "No matching case"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.986047+00', '[{"name": "default", "label": "Default", "is_default": true, "description": "When no case matches"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Value to switch on"}]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('1b182587-c5c1-4bda-aa14-0c456459be1a', NULL, 'notion_query_db', 'Notion: DB検索', 'Notionデータベースを検索', 'integration', 'database', '{"type": "object", "required": ["database_id"], "properties": {"sorts": {"type": "array", "title": "ソート", "description": "ソート条件（JSON配列）", "x-ui-widget": "output-schema"}, "filter": {"type": "object", "title": "フィルター", "description": "Notion Filter形式（JSON）", "x-ui-widget": "output-schema"}, "api_key": {"type": "string", "title": "API Key", "description": "Notion API Key（空の場合はシークレットNOTION_API_KEYを使用）"}, "page_size": {"type": "number", "title": "取得件数", "default": 100, "maximum": 100, "minimum": 1}, "database_id": {"type": "string", "title": "データベースID", "description": "検索対象のデータベースID"}}}', '{"type": "object", "properties": {"filter": {"type": "object", "description": "検索フィルター条件"}}, "description": "フィルター条件で参照可能なデータ"}', '{"type": "object", "properties": {"results": {"type": "array"}, "has_more": {"type": "boolean"}, "next_cursor": {"type": "string"}}}', '[{"code": "NOTION_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "NOTION_004", "name": "QUERY_FAILED", "retryable": true, "description": "クエリに失敗しました"}]', true, '2026-01-12 09:23:30.220729+00', '2026-01-13 09:35:31.992122+00', '[]', '[]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('5eddf8f1-4913-4c29-8934-68c59a72e603', NULL, 'gsheets_append', 'Google Sheets: 行追加', 'Google Sheetsに行を追加', 'integration', 'table', '{"type": "object", "required": ["spreadsheet_id", "values"], "properties": {"range": {"type": "string", "title": "範囲", "default": "Sheet1!A:Z", "description": "シート名と範囲（例: Sheet1!A:Z）"}, "values": {"type": "array", "title": "値", "description": "追加する行データ（2次元配列またはテンプレート）", "x-ui-widget": "output-schema"}, "api_key": {"type": "string", "title": "API Key", "description": "Google API Key（空の場合はシークレットGOOGLE_API_KEYを使用）"}, "spreadsheet_id": {"type": "string", "title": "スプレッドシートID", "description": "URLから取得: /d/{spreadsheet_id}/edit"}, "value_input_option": {"enum": ["RAW", "USER_ENTERED"], "type": "string", "title": "入力形式", "default": "USER_ENTERED"}}}', '{"type": "object", "properties": {"values": {"type": "array", "description": "追加する行データ"}}, "description": "行追加テンプレートで参照可能なデータ"}', '{"type": "object", "properties": {"updated_rows": {"type": "number"}, "updated_cells": {"type": "number"}, "updated_range": {"type": "string"}}}', '[{"code": "GSHEETS_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "GSHEETS_002", "name": "APPEND_FAILED", "retryable": true, "description": "行追加に失敗しました"}, {"code": "GSHEETS_003", "name": "INVALID_SPREADSHEET", "retryable": false, "description": "スプレッドシートが見つかりません"}]', true, '2026-01-12 09:23:30.221106+00', '2026-01-13 09:35:31.992344+00', '[]', '[]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('08877c27-e58f-413b-ab8e-bffdf113f269', NULL, 'github_create_issue', 'GitHub: Issue作成', 'GitHubリポジトリにIssueを作成', 'integration', 'git-pull-request', '{"type": "object", "required": ["owner", "repo", "title"], "properties": {"body": {"type": "string", "title": "本文", "description": "Issue本文（Markdown、テンプレート使用可）", "x-ui-widget": "textarea"}, "repo": {"type": "string", "title": "リポジトリ", "description": "リポジトリ名"}, "owner": {"type": "string", "title": "オーナー", "description": "リポジトリオーナー（ユーザー名または組織名）"}, "title": {"type": "string", "title": "タイトル", "description": "Issueタイトル（テンプレート使用可）"}, "token": {"type": "string", "title": "アクセストークン", "description": "GitHub Personal Access Token（空の場合はシークレットGITHUB_TOKENを使用）"}, "labels": {"type": "array", "items": {"type": "string"}, "title": "ラベル", "description": "ラベル名の配列"}, "assignees": {"type": "array", "items": {"type": "string"}, "title": "アサイン", "description": "アサインするユーザー名の配列"}}}', '{"type": "object", "properties": {"body": {"type": "string", "description": "Issue本文"}, "title": {"type": "string", "description": "Issueタイトル"}, "labels": {"type": "array", "description": "ラベル"}}, "description": "Issue作成テンプレートで参照可能なデータ"}', '{"type": "object", "properties": {"id": {"type": "number"}, "url": {"type": "string"}, "number": {"type": "number"}, "html_url": {"type": "string"}}}', '[{"code": "GITHUB_001", "name": "TOKEN_NOT_CONFIGURED", "retryable": false, "description": "トークンが設定されていません"}, {"code": "GITHUB_002", "name": "CREATE_FAILED", "retryable": true, "description": "Issue作成に失敗しました"}, {"code": "GITHUB_003", "name": "REPO_NOT_FOUND", "retryable": false, "description": "リポジトリが見つかりません"}]', true, '2026-01-12 09:23:30.221947+00', '2026-01-13 09:35:31.992787+00', '[]', '[]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('e1d99e22-5348-4e8b-9c44-a1a7e82cbb83', NULL, 'web_search', 'Web検索', 'Tavily APIでWeb検索を実行', 'integration', 'search', '{"type": "object", "required": ["query"], "properties": {"query": {"type": "string", "title": "検索クエリ", "description": "検索キーワード（テンプレート使用可）"}, "api_key": {"type": "string", "title": "API Key", "description": "Tavily API Key（空の場合はシークレットTAVILY_API_KEYを使用）"}, "max_results": {"type": "number", "title": "最大結果数", "default": 5, "maximum": 20, "minimum": 1}, "search_depth": {"enum": ["basic", "advanced"], "type": "string", "title": "検索深度", "default": "basic"}, "include_answer": {"type": "boolean", "title": "AI回答を含める", "default": true}, "exclude_domains": {"type": "array", "items": {"type": "string"}, "title": "除外ドメイン"}, "include_domains": {"type": "array", "items": {"type": "string"}, "title": "含めるドメイン"}}}', '{"type": "object", "properties": {"query": {"type": "string", "description": "検索クエリ"}}, "description": "Web検索に使用するデータ"}', '{"type": "object", "properties": {"answer": {"type": "string"}, "results": {"type": "array", "items": {"type": "object", "properties": {"url": {"type": "string"}, "score": {"type": "number"}, "title": {"type": "string"}, "content": {"type": "string"}}}}}}', '[{"code": "SEARCH_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "SEARCH_002", "name": "SEARCH_FAILED", "retryable": true, "description": "検索に失敗しました"}]', true, '2026-01-12 09:23:30.222703+00', '2026-01-13 09:35:31.996229+00', '[]', '[]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('decf6fc1-edff-43dc-90bf-23b76d5ffdcf', NULL, 'condition', 'Condition', 'Branch based on expression', 'logic', 'git-branch', '{"type": "object", "properties": {"expression": {"type": "string", "description": "JSONPath expression"}}}', '{"type": "object", "properties": {"value": {"type": "any", "description": "条件式で評価する値"}}, "description": "条件式で評価されるデータ"}', NULL, '[{"code": "COND_001", "name": "INVALID_EXPR", "retryable": false, "description": "Invalid condition expression"}, {"code": "COND_002", "name": "EVAL_ERROR", "retryable": false, "description": "Expression evaluation error"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.985676+00', '[{"name": "true", "label": "Yes", "is_default": true, "description": "When condition is true"}, {"name": "false", "label": "No", "is_default": false, "description": "When condition is false"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Data to evaluate condition against"}]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('2319b4e4-2060-4341-b8ab-18c6196b005b', NULL, 'loop', 'Loop', 'Iterate with for/forEach/while', 'logic', 'repeat', '{"type": "object", "properties": {"count": {"type": "integer"}, "condition": {"type": "string"}, "loop_type": {"enum": ["for", "forEach", "while", "doWhile"], "type": "string"}, "input_path": {"type": "string"}, "max_iterations": {"type": "integer"}}}', '{"type": "object", "properties": {"data": {"type": "object", "description": "ループ内で参照可能なデータ"}, "items": {"type": "array", "description": "forEach時のループ対象配列"}}, "description": "ループ処理に使用するデータ"}', NULL, '[{"code": "LOOP_001", "name": "MAX_ITERATIONS", "retryable": false, "description": "Maximum iterations exceeded"}]', true, '2026-01-12 09:23:29.067836+00', '2026-01-13 09:35:31.986611+00', '[{"name": "loop", "label": "Loop Body", "is_default": true, "description": "Each iteration"}, {"name": "complete", "label": "Complete", "is_default": false, "description": "When loop finishes"}]', '[{"name": "input", "label": "Input", "schema": {"type": "any"}, "required": true, "description": "Initial value or array to iterate"}]', '[]', false, '
const results = [];
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('4192fef4-6164-412a-920f-f9d9143fb790', NULL, 'discord', 'Discord', 'Discord Webhookにメッセージを送信', 'integration', 'message-circle', '{"type": "object", "required": ["content"], "properties": {"embeds": {"type": "array", "title": "Embeds", "description": "リッチな埋め込みメッセージ（JSON配列）", "x-ui-widget": "output-schema"}, "content": {"type": "string", "title": "メッセージ", "description": "送信するメッセージ（テンプレート使用可）", "x-ui-widget": "textarea"}, "username": {"type": "string", "title": "ユーザー名", "description": "Webhookの表示名を上書き"}, "avatar_url": {"type": "string", "title": "アバターURL", "description": "Webhookのアバター画像URL"}, "webhook_url": {"type": "string", "title": "Webhook URL", "description": "Discord Webhook URL（空の場合はシークレットDISCORD_WEBHOOK_URLを使用）"}}}', '{"type": "object", "properties": {"title": {"type": "string", "description": "通知タイトル"}, "content": {"type": "string", "description": "通知する本文内容"}, "status": {"type": "string", "description": "ステータス（success/error/warning等）"}, "url": {"type": "string", "description": "関連URL"}}, "description": "Discord通知テンプレートで使用するデータ"}', '{"type": "object", "properties": {"status": {"type": "number"}, "success": {"type": "boolean"}}}', '[{"code": "DISCORD_001", "name": "WEBHOOK_NOT_CONFIGURED", "retryable": false, "description": "Webhook URLが設定されていません"}, {"code": "DISCORD_002", "name": "SEND_FAILED", "retryable": true, "description": "メッセージ送信に失敗しました"}, {"code": "DISCORD_003", "name": "RATE_LIMITED", "retryable": true, "description": "レート制限に達しました"}]', true, '2026-01-12 09:23:30.219664+00', '2026-01-13 09:35:31.991259+00', '[]', '[]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('207aaa19-cd68-4bd4-b42c-d670fae4e77c', NULL, 'slack', 'Slack', 'Slackチャンネルにメッセージを送信', 'integration', 'message-square', '{"type": "object", "required": ["message"], "properties": {"blocks": {"type": "array", "title": "Block Kit", "description": "Slack Block Kit形式のメッセージ（JSON）", "x-ui-widget": "output-schema"}, "channel": {"type": "string", "title": "チャンネル", "description": "投稿先チャンネル（#general など）"}, "message": {"type": "string", "title": "メッセージ", "description": "送信するメッセージ（テンプレート使用可: ${input.field}）", "x-ui-widget": "textarea"}, "username": {"type": "string", "title": "表示名", "description": "ボットの表示名"}, "icon_emoji": {"type": "string", "title": "アイコン絵文字", "description": "ボットのアイコン（:robot_face: など）"}, "webhook_url": {"type": "string", "title": "Webhook URL", "description": "Slack Incoming Webhook URL（空の場合はシークレットSLACK_WEBHOOK_URLを使用）"}}}', '{"type": "object", "properties": {"title": {"type": "string", "description": "通知タイトル"}, "text": {"type": "string", "description": "通知する本文内容"}, "status": {"type": "string", "description": "ステータス（success/error/warning等）"}, "channel": {"type": "string", "description": "投稿先チャンネル"}}, "description": "Slack通知テンプレートで使用するデータ"}', '{"type": "object", "properties": {"status": {"type": "number"}, "success": {"type": "boolean"}}}', '[{"code": "SLACK_001", "name": "WEBHOOK_NOT_CONFIGURED", "retryable": false, "description": "Webhook URLが設定されていません"}, {"code": "SLACK_002", "name": "SEND_FAILED", "retryable": true, "description": "メッセージ送信に失敗しました"}, {"code": "SLACK_003", "name": "INVALID_WEBHOOK", "retryable": false, "description": "無効なWebhook URL"}]', true, '2026-01-12 09:23:30.218182+00', '2026-01-13 09:35:31.990847+00', '[]', '[]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('fa2509a4-f899-4761-a20d-f67122fd2e1d', NULL, 'email_sendgrid', 'Email (SendGrid)', 'SendGrid APIでメールを送信', 'integration', 'mail', '{"type": "object", "required": ["from_email", "to_email", "subject", "content"], "properties": {"api_key": {"type": "string", "title": "API Key", "description": "SendGrid API Key（空の場合はシークレットSENDGRID_API_KEYを使用）"}, "content": {"type": "string", "title": "本文", "description": "メール本文（テンプレート使用可）", "x-ui-widget": "textarea"}, "subject": {"type": "string", "title": "件名", "description": "メール件名（テンプレート使用可）"}, "to_name": {"type": "string", "title": "受信者名"}, "to_email": {"type": "string", "title": "宛先メール", "description": "受信者のメールアドレス（テンプレート使用可）"}, "from_name": {"type": "string", "title": "送信者名"}, "from_email": {"type": "string", "title": "送信元メール", "description": "送信者のメールアドレス"}, "content_type": {"enum": ["text/plain", "text/html"], "type": "string", "title": "本文形式", "default": "text/plain"}}}', '{"type": "object", "properties": {"to_email": {"type": "string", "description": "受信者メールアドレス"}, "to_name": {"type": "string", "description": "受信者名"}, "subject": {"type": "string", "description": "メール件名"}, "body": {"type": "string", "description": "メール本文"}}, "description": "メール送信テンプレートで使用するデータ"}', '{"type": "object", "properties": {"success": {"type": "boolean"}, "message_id": {"type": "string"}}}', '[{"code": "EMAIL_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "EMAIL_002", "name": "SEND_FAILED", "retryable": true, "description": "メール送信に失敗しました"}, {"code": "EMAIL_003", "name": "INVALID_EMAIL", "retryable": false, "description": "メールアドレスが無効です"}]', true, '2026-01-12 09:23:30.223087+00', '2026-01-13 09:35:31.991485+00', '[]', '[]', '[]', false, '
...
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('608c9830-b4b8-42f3-9716-9289b263188c', NULL, 'notion_create_page', 'Notion: ページ作成', 'Notionにページを作成', 'integration', 'file-text', '{"type": "object", "required": ["parent_id"], "properties": {"title": {"type": "string", "title": "タイトル", "description": "ページタイトル（テンプレート使用可）"}, "api_key": {"type": "string", "title": "API Key", "description": "Notion API Key（空の場合はシークレットNOTION_API_KEYを使用）"}, "content": {"type": "string", "title": "本文", "description": "ページの本文コンテンツ（テンプレート使用可）", "x-ui-widget": "textarea"}, "parent_id": {"type": "string", "title": "親ID", "description": "親ページまたはデータベースのID"}, "properties": {"type": "object", "title": "プロパティ", "description": "DBプロパティ（JSON形式）", "x-ui-widget": "output-schema"}, "parent_type": {"enum": ["page_id", "database_id"], "type": "string", "title": "親タイプ", "default": "database_id"}}}', '{"type": "object", "properties": {"title": {"type": "string", "description": "ページタイトル"}, "content": {"type": "string", "description": "ページコンテンツ"}, "properties": {"type": "object", "description": "DBプロパティ"}}, "description": "ページ作成テンプレートで参照可能なデータ"}', '{"type": "object", "properties": {"id": {"type": "string"}, "url": {"type": "string"}, "created_time": {"type": "string"}}}', '[{"code": "NOTION_001", "name": "API_KEY_NOT_CONFIGURED", "retryable": false, "description": "API Keyが設定されていません"}, {"code": "NOTION_002", "name": "CREATE_FAILED", "retryable": true, "description": "ページ作成に失敗しました"}, {"code": "NOTION_003", "name": "INVALID_PARENT", "retryable": false, "description": "無効な親IDです"}]', true, '2026-01-12 09:23:30.220201+00', '2026-01-13 09:35:31.991742+00', '[]', '[]', '[]', false, '
const apiKey = config.api_key || ctx.secrets.NOTION_API_KEY;
if (!apiKey) {
    throw new Error(''[NOTION_001] API Keyが設定されていません'');
}
...
return {
    ...
    ', '{"icon": "table", "color": "#0F9D58"}', true, 1);
INSERT INTO block_definitions (id, tenant_id, slug, name, description, category, icon, config_schema, input_schema, output_schema, error_codes, enabled, created_at, updated_at, output_ports, input_ports, required_credentials, is_public, code, ui_config, is_system, version) VALUES ('825d2ae5-9808-496d-b4e0-dcf2f8e6afe5', NULL, 'github_add_comment', 'GitHub: コメント追加', 'GitHub IssueまたはPRにコメントを追加', 'integration', 'message-square', '{"type": "object", "required": ["owner", "repo", "issue_number", "body"], "properties": {"body": {"type": "string", "title": "コメント本文", "description": "コメント本文（Markdown、テンプレート使用可）", "x-ui-widget": "textarea"}, "repo": {"type": "string", "title": "リポジトリ"}, "owner": {"type": "string", "title": "オーナー"}, "token": {"type": "string", "title": "アクセストークン", "description": "GitHub Personal Access Token（空の場合はシークレットGITHUB_TOKENを使用）"}, "issue_number": {"type": "number", "title": "Issue/PR番号"}}}', '{"type": "object", "properties": {"comment": {"type": "string", "description": "コメント本文"}}, "description": "コメント追加テンプレートで参照可能なデータ"}', '{"type": "object", "properties": {"id": {"type": "number"}, "url": {"type": "string"}, "html_url": {"type": "string"}}}', '[{"code": "GITHUB_001", "name": "TOKEN_NOT_CONFIGURED", "retryable": false, "description": "トークンが設定されていません"}, {"code": "GITHUB_004", "name": "COMMENT_FAILED", "retryable": true, "description": "コメント追加に失敗しました"}]', true, '2026-01-12 09:23:30.222311+00', '2026-01-13 09:35:31.993045+00', '[]', '[]', '[]', false, '
const token = config.token || ctx.secrets.GITHUB_TOKEN;
if (!token) {
    throw new Error(''[GITHUB_001] トークンが設定されていません'');
}
...
INSERT INTO workflows (id, tenant_id, name, description, status, version, input_schema, output_schema, draft, created_by, published_at, created_at, updated_at, deleted_at, is_system, system_slug) VALUES ('a0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Copilot: Generate Workflow', 'Generates workflow structures from natural language descriptions using AI', 'published', 1, '{"type": "object", "required": ["prompt"], "properties": {"prompt": {"type": "string", "title": "説明", "description": "生成したいワークフローの説明を入力してください"}}}', NULL, NULL, NULL, '2026-01-12 09:23:30.439548+00', '2026-01-12 09:23:30.439548+00', '2026-01-12 09:23:30.439548+00', NULL, true, 'copilot-generate');
INSERT INTO workflows (id, tenant_id, name, description, status, version, input_schema, output_schema, draft, created_by, published_at, created_at, updated_at, deleted_at, is_system, system_slug) VALUES ('a0000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Copilot: Suggest Steps', 'Suggests next steps for a workflow based on current structure', 'published', 1, '{"type": "object", "required": ["workflow_id"], "properties": {"context": {"type": "string", "title": "コンテキスト", "description": "追加のコンテキスト情報（オプション）"}, "workflow_id": {"type": "string", "title": "ワークフローID", "description": "ステップを提案するワークフローのID"}}}', NULL, NULL, NULL, '2026-01-12 09:23:30.443322+00', '2026-01-12 09:23:30.443322+00', '2026-01-12 09:23:30.443322+00', NULL, true, 'copilot-suggest');
INSERT INTO workflows (id, tenant_id, name, description, status, version, input_schema, output_schema, draft, created_by, published_at, created_at, updated_at, deleted_at, is_system, system_slug) VALUES ('a0000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'Copilot: Diagnose Error', 'Diagnoses workflow execution errors and suggests fixes', 'published', 1, '{"type": "object", "required": ["run_id"], "properties": {"run_id": {"type": "string", "title": "実行ID", "description": "診断する実行のID"}}}', NULL, NULL, NULL, '2026-01-12 09:23:30.444644+00', '2026-01-12 09:23:30.444644+00', '2026-01-12 09:23:30.444644+00', NULL, true, 'copilot-diagnose');
INSERT INTO workflows (id, tenant_id, name, description, status, version, input_schema, output_schema, draft, created_by, published_at, created_at, updated_at, deleted_at, is_system, system_slug) VALUES ('a0000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'Copilot: Optimize Workflow', 'Suggests optimizations for workflow performance, cost, and reliability', 'published', 1, '{"type": "object", "required": ["workflow_id"], "properties": {"workflow_id": {"type": "string", "title": "ワークフローID", "description": "最適化するワークフローのID"}}}', NULL, NULL, NULL, '2026-01-12 09:23:30.445469+00', '2026-01-12 09:23:30.445469+00', '2026-01-12 09:23:30.445469+00', NULL, true, 'copilot-optimize');
...
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Start', 'start', '{"input_schema": {"type": "object", "required": ["prompt"], "properties": {"prompt": {"type": "string", "title": "説明", "description": "生成したいワークフローの説明を入力してください"}}}}', 400, 50, '2026-01-12 09:23:30.44145+00', '2026-01-12 09:23:30.44145+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000002-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Get Available Blocks', 'function', '{"code": "const blocks = context.blocks.list(); return { blocks: blocks.map(b => ({ slug: b.slug, name: b.name, description: b.description, category: b.category })) };", "language": "javascript", "output_schema": {"type": "object", "properties": {"blocks": {"type": "array", "title": "ブロック一覧", "description": "利用可能なブロックの配列"}}, "required": ["blocks"]}}', 400, 200, '2026-01-12 09:23:30.44145+00', '2026-01-12 09:23:30.44145+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000003-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Build Prompt', 'function', '{"code": "const blocksInfo = input.blocks.map(b => `- ${b.slug}: ${b.name} (${b.category}) - ${b.description || \"\"}`).join(\"\\n\");\nconst prompt = `You are an AI workflow generator. Generate a workflow based on the user description.\\n\\n## Available Blocks\\n${blocksInfo}\\n\\n## Available Step Types\\n- start: Entry point (required)\\n- llm: AI/LLM call\\n- tool: External adapter\\n- condition: Binary branch (true/false)\\n- switch: Multi-way branch\\n- map: Parallel array processing\\n- loop: Iteration\\n- wait: Delay\\n- function: Custom JavaScript\\n- log: Debug logging\\n\\n## User Request\\n${input.prompt}\\n\\n## Output Format (JSON)\\n{\\n  \"response\": \"Explanation\",\\n  \"steps\": [{\"temp_id\": \"step_1\", \"name\": \"Step Name\", \"type\": \"start\", \"description\": \"\", \"config\": {}, \"position_x\": 400, \"position_y\": 50}],\\n  \"edges\": [{\"source_temp_id\": \"step_1\", \"target_temp_id\": \"step_2\", \"source_port\": \"default\"}],\\n  \"start_step_id\": \"step_1\"\\n}\\n\\nGenerate a valid workflow JSON. Always include a start step.`;\nreturn { prompt: prompt };", "language": "javascript", "output_schema": {"type": "object", "properties": {"prompt": {"type": "string", "title": "プロンプト", "description": "LLMに送信するプロンプト"}}, "required": ["prompt"]}}', 400, 350, '2026-01-12 09:23:30.44145+00', '2026-01-12 09:23:30.44145+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000004-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Generate with LLM', 'llm', '{"model": "gpt-4o-mini", "provider": "openai", "max_tokens": 4000, "temperature": 0.3, "user_prompt": "{{$.prompt}}", "system_prompt": "You are an AI workflow generator. Always respond with valid JSON."}', 400, 500, '2026-01-12 09:23:30.44145+00', '2026-01-12 09:23:30.44145+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000005-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Parse & Validate', 'function', '{"code": "try { let content = input.content || \"\"; if (content.startsWith(\"```json\")) content = content.slice(7); if (content.startsWith(\"```\")) content = content.slice(3); if (content.endsWith(\"```\")) content = content.slice(0, -3); content = content.trim(); const result = JSON.parse(content); if (!result.steps || !Array.isArray(result.steps)) { return { error: \"Invalid workflow: missing steps array\" }; } const validTypes = [\"start\", \"llm\", \"tool\", \"condition\", \"switch\", \"map\", \"join\", \"subflow\", \"loop\", \"wait\", \"function\", \"router\", \"human_in_loop\", \"filter\", \"split\", \"aggregate\", \"error\", \"note\", \"log\"]; result.steps = result.steps.filter(s => validTypes.includes(s.type)); return result; } catch (e) { return { error: \"Failed to parse LLM response: \" + e.message }; }", "language": "javascript", "output_schema": {"type": "object", "properties": {"response": {"type": "string", "title": "レスポンス"}, "steps": {"type": "array", "title": "ステップ", "description": "生成されたステップの配列"}, "edges": {"type": "array", "title": "エッジ", "description": "ステップ間の接続"}, "start_step_id": {"type": "string", "title": "開始ステップID"}, "error": {"type": "string", "title": "エラー"}}}}', 400, 650, '2026-01-12 09:23:30.44145+00', '2026-01-12 09:23:30.44145+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000003-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'Build Suggest Prompt', 'function', '{"code": "const wf = input.workflow; const blocksInfo = input.blocks.slice(0, 20).map(b => `- ${b.slug}: ${b.name}`).join(\"\\n\"); const stepsInfo = (wf.steps || []).map(s => `- ${s.name} (${s.type})`).join(\"\\n\"); const prompt = `Suggest 2-3 next steps for this workflow.\\n\\n## Current Steps\\n${stepsInfo || \"(empty)\"}\\n\\n## Available Blocks\\n${blocksInfo}\\n\\n## Context\\n${input.context || \"\"}\\n\\nReturn JSON array: [{\"type\": \"...\", \"name\": \"...\", \"description\": \"...\", \"config\": {}, \"reason\": \"...\"}]`; return { prompt: prompt };", "language": "javascript"}', 400, 350, '2026-01-12 09:23:30.443723+00', '2026-01-12 09:23:30.443723+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000004-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'Suggest with LLM', 'llm', '{"model": "gpt-4o-mini", "provider": "openai", "max_tokens": 2000, "temperature": 0.5, "user_prompt": "{{$.prompt}}", "system_prompt": "You are an AI workflow assistant. Return valid JSON array."}', 400, 500, '2026-01-12 09:23:30.443723+00', '2026-01-12 09:23:30.443723+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000005-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'Parse Suggestions', 'function', '{"code": "try { let content = input.content || \"\"; if (content.startsWith(\"```\")) { content = content.replace(/```json?\\n?/g, \"\").replace(/```/g, \"\").trim(); } const suggestions = JSON.parse(content); return { suggestions: Array.isArray(suggestions) ? suggestions : [] }; } catch (e) { return { suggestions: [] }; }", "language": "javascript"}', 400, 650, '2026-01-12 09:23:30.443723+00', '2026-01-12 09:23:30.443723+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000001-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'Start', 'start', '{"input_schema": {"type": "object", "required": ["run_id"], "properties": {"run_id": {"type": "string", "title": "実行ID", "description": "診断する実行のID"}}}}', 400, 50, '2026-01-12 09:23:30.444897+00', '2026-01-12 09:23:30.444897+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000002-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'Get Run Details', 'function', '{"code": "const run = context.runs.get(input.run_id); const stepRuns = context.runs.getStepRuns(input.run_id); const failedSteps = stepRuns.filter(sr => sr.status === \"failed\"); return { run: run, stepRuns: stepRuns, failedSteps: failedSteps };", "language": "javascript"}', 400, 200, '2026-01-12 09:23:30.444897+00', '2026-01-12 09:23:30.444897+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000003-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'Build Diagnose Prompt', 'function', '{"code": "const failedInfo = input.failedSteps.map(sr => `Step: ${sr.step_name}\\nError: ${sr.error || \"Unknown\"}\\nInput: ${JSON.stringify(sr.input || {})}`).join(\"\\n\\n\"); const prompt = `Diagnose this workflow error.\\n\\n## Run Status: ${input.run.status}\\n\\n## Failed Steps\\n${failedInfo || \"No failures found\"}\\n\\nReturn JSON: {\"diagnosis\": {\"root_cause\": \"...\", \"category\": \"config_error|input_error|api_error|logic_error|timeout|unknown\", \"severity\": \"high|medium|low\"}, \"fixes\": [{\"description\": \"...\", \"steps\": [\"...\"]}], \"preventions\": [\"...\"]}`; return { prompt: prompt };", "language": "javascript"}', 400, 350, '2026-01-12 09:23:30.444897+00', '2026-01-12 09:23:30.444897+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000004-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'Diagnose with LLM', 'llm', '{"model": "gpt-4o-mini", "provider": "openai", "max_tokens": 2000, "temperature": 0.3, "user_prompt": "{{$.prompt}}", "system_prompt": "You are an AI debugging assistant. Return valid JSON."}', 400, 500, '2026-01-12 09:23:30.444897+00', '2026-01-12 09:23:30.444897+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000005-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'Parse Diagnosis', 'function', '{"code": "try { let content = input.content || \"\"; if (content.startsWith(\"```\")) { content = content.replace(/```json?\\n?/g, \"\").replace(/```/g, \"\").trim(); } return JSON.parse(content); } catch (e) { return { diagnosis: { root_cause: \"Parse error\", category: \"unknown\", severity: \"low\" }, fixes: [], preventions: [] }; }", "language": "javascript"}', 400, 650, '2026-01-12 09:23:30.444897+00', '2026-01-12 09:23:30.444897+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000001-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'Start', 'start', '{"input_schema": {"type": "object", "required": ["workflow_id"], "properties": {"workflow_id": {"type": "string", "title": "ワークフローID", "description": "最適化するワークフローのID"}}}}', 400, 50, '2026-01-12 09:23:30.445696+00', '2026-01-12 09:23:30.445696+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000002-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'Get Workflow Details', 'function', '{"code": "const workflow = context.workflows.get(input.workflow_id); return { workflow: workflow };", "language": "javascript"}', 400, 200, '2026-01-12 09:23:30.445696+00', '2026-01-12 09:23:30.445696+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000003-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'Build Optimize Prompt', 'function', '{"code": "const wf = input.workflow; const stepsInfo = (wf.steps || []).map(s => `- ${s.name} (${s.type}): ${JSON.stringify(s.config || {})}`).join(\"\\n\"); const prompt = `Suggest optimizations for this workflow.\\n\\n## Workflow: ${wf.name}\\n## Steps (${(wf.steps || []).length})\\n${stepsInfo}\\n\\nReturn JSON: {\"optimizations\": [{\"category\": \"performance|cost|reliability|maintainability\", \"title\": \"...\", \"description\": \"...\", \"impact\": \"high|medium|low\", \"effort\": \"high|medium|low\"}], \"summary\": \"...\"}`; return { prompt: prompt };", "language": "javascript"}', 400, 350, '2026-01-12 09:23:30.445696+00', '2026-01-12 09:23:30.445696+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000004-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'Optimize with LLM', 'llm', '{"model": "gpt-4o-mini", "provider": "openai", "max_tokens": 2000, "temperature": 0.5, "user_prompt": "{{$.prompt}}", "system_prompt": "You are an AI optimization assistant. Return valid JSON."}', 400, 500, '2026-01-12 09:23:30.445696+00', '2026-01-12 09:23:30.445696+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000005-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'Parse Optimizations', 'function', '{"code": "try { let content = input.content || \"\"; if (content.startsWith(\"```\")) { content = content.replace(/```json?\\n?/g, \"\").replace(/```/g, \"\").trim(); } return JSON.parse(content); } catch (e) { return { optimizations: [], summary: \"Parse error\" }; }", "language": "javascript"}', 400, 650, '2026-01-12 09:23:30.445696+00', '2026-01-12 09:23:30.445696+00', NULL, NULL, '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000001-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'Start', 'start', '{"input_schema": {"type": "object", "required": ["workflow_id"], "properties": {"context": {"type": "string", "title": "コンテキスト", "description": "追加のコンテキスト情報（オプション）"}, "workflow_id": {"type": "string", "title": "ワークフローID", "description": "ステップを提案するワークフローのID"}}}}', 180, 180, '2026-01-12 09:23:30.443723+00', '2026-01-13 09:30:58.707281+00', NULL, '', '{}', NULL);
INSERT INTO steps (id, tenant_id, workflow_id, name, type, config, position_x, position_y, created_at, updated_at, block_group_id, group_role, credential_bindings, block_definition_id) VALUES ('b0000002-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'Get Workflow Context', 'function', '{"code": "const workflow = context.workflows.get(input.workflow_id); const blocks = context.blocks.list(); return { workflow: workflow, blocks: blocks };", "language": "javascript"}', 400, 200, '2026-01-12 09:23:30.443723+00', '2026-01-13 09:30:59.802138+00', NULL, '', '{}', NULL);
...
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000001', 'b0000002-0000-0000-0000-000000000001', NULL, '2026-01-12 09:23:30.442384+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000002-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'b0000002-0000-0000-0000-000000000001', 'b0000003-0000-0000-0000-000000000001', NULL, '2026-01-12 09:23:30.442384+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000003-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'b0000003-0000-0000-0000-000000000001', 'b0000004-0000-0000-0000-000000000001', NULL, '2026-01-12 09:23:30.442384+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000004-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'b0000004-0000-0000-0000-000000000001', 'b0000005-0000-0000-0000-000000000001', NULL, '2026-01-12 09:23:30.442384+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000001-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'b0000001-0000-0000-0000-000000000002', 'b0000002-0000-0000-0000-000000000002', NULL, '2026-01-12 09:23:30.444173+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000002-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'b0000002-0000-0000-0000-000000000002', 'b0000003-0000-0000-0000-000000000002', NULL, '2026-01-12 09:23:30.444173+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000003-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'b0000003-0000-0000-0000-000000000002', 'b0000004-0000-0000-0000-000000000002', NULL, '2026-01-12 09:23:30.444173+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000004-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'b0000004-0000-0000-0000-000000000002', 'b0000005-0000-0000-0000-000000000002', NULL, '2026-01-12 09:23:30.444173+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000001-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'b0000001-0000-0000-0000-000000000003', 'b0000002-0000-0000-0000-000000000003', NULL, '2026-01-12 09:23:30.445176+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000002-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'b0000002-0000-0000-0000-000000000003', 'b0000003-0000-0000-0000-000000000003', NULL, '2026-01-12 09:23:30.445176+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000003-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'b0000003-0000-0000-0000-000000000003', 'b0000004-0000-0000-0000-000000000003', NULL, '2026-01-12 09:23:30.445176+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000004-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 'b0000004-0000-0000-0000-000000000003', 'b0000005-0000-0000-0000-000000000003', NULL, '2026-01-12 09:23:30.445176+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000001-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'b0000001-0000-0000-0000-000000000004', 'b0000002-0000-0000-0000-000000000004', NULL, '2026-01-12 09:23:30.446+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000002-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'b0000002-0000-0000-0000-000000000004', 'b0000003-0000-0000-0000-000000000004', NULL, '2026-01-12 09:23:30.446+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000003-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'b0000003-0000-0000-0000-000000000004', 'b0000004-0000-0000-0000-000000000004', NULL, '2026-01-12 09:23:30.446+00', 'output', '');
INSERT INTO edges (id, tenant_id, workflow_id, source_step_id, target_step_id, condition, created_at, source_port, target_port) VALUES ('c0000004-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 'b0000004-0000-0000-0000-000000000004', 'b0000005-0000-0000-0000-000000000004', NULL, '2026-01-12 09:23:30.446+00', 'output', '');
